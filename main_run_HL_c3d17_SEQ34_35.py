...
def main(DATASET, LABELS, featuresPath, base_name, c3dWinSize=16, SEQ_SIZE=16, \
...
if __name__=='__main__':
    ...
    base_name = "/home/arpan/VisionWorkspace/Cricket/localization_gru/logs/GRU_c3dFine_log_hidden1k_"+str(c3dWinSize)
    # Server Paths
    if os.path.exists("/opt/datasets/cricket/ICC_WT20"):
        ...
        base_name = "/home/arpan/VisionWorkspace/localization_gru/logs/GRU_c3dFine_log_hidden1k_"+str(c3dWinSize)
