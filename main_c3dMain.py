...
base_name = "/home/arpan/VisionWorkspace/Cricket/localization_gru/logs/GRU_c3dFineMainHL_log_hidden1k_ep90_"+str(c3dWinSize)
...
if os.path.exists("/opt/datasets/cricket/ICC_WT20"):
    ...
    base_name = "/home/arpan/VisionWorkspace/localization_gru/logs/GRU_c3dFineMainHL_log_hidden1k_ep90_"+str(c3dWinSize)
...
def main(base_name, c3dWinSize=16, SEQ_SIZE=16, \
    ...
    print("No. of training videos : {}".format(len(train_lst)+len(train_lst_main)))
...
#    print("Size : {}".format(val_sizes_main))
    ...
    classifier.eval()
    val_keys, predictions = predict(c3dFC7ValFeatsPath, val_lst_main, classifier, val_loader, \
          c3dWinSize, use_gpu)
